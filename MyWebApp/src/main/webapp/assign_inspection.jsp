...
<body>
	...
	<div class="container">
		<div class="form-container">
			...
			JSONObject empDtlsJson= new JSONObject(empDtls);
			String tkn= empDtlsJson.getString("tkn");
			empDtlsJson.remove("tkn");
			String xUid= empDtlsJson.getString("xUid");
			String pageNm= "DASH";
			String empAssignedBy= empDtlsJson.getString("erpId");
...
<!-- 				<div class="mb-3 row">
				...
				<div class="mb-3 row">
					<div class="col-sm-12 text-center">
						<button type="button" class="btn btn-primary" id="submitbtn">Assign
							Inspection</button>
					</div>
				</div>
			</form>
