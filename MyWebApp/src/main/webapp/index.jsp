    ...
    <div class="container login-container mt-5">
        ...
        <div class="form-row">
            <div class="form-group col-md-12 d-flex justify-content-center">
                <button type="button" class="btn btn-primary" id="loginbttn" style="width: 50%;">Login</button>
            </div>
        </div>
        ...
        <div class="form-row" id="otpMessage" style="display: none;">
            <div class="form-group col-md-12 text-center">
                <p class="text-info">A one-time password has been sent to your registered mobile number *********</p>
            </div>
        </div>
        ...
        <form id="otpForm" style="display: none;">
            <div class="form-row">
                ...
                <div class="form-group col-md-12 d-flex justify-content-center">
                    <button type="button" class="btn btn-primary" id="submitOtpBtn" style="width: 50%;" onclick="submitOtp()" disabled>Submit OTP</button>
                </div>
                <div id="otpError" class="alert alert-danger" role="alert" style="display: none;"></div>
            </div>
        </form>
    </div>
