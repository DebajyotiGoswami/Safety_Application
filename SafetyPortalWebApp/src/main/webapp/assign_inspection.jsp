...
<body>
	...
	<div class="container">
		<div class="form-container">
			...
			empDtlsJsonObj.remove("tkn");
			String xUid= empDtlsJsonObj.getString("xUid");
			String pageNm= "DASH";
			String empAssignedBy= empDtlsJsonObj.getString("erpId");
			String officeNm= empDtlsJsonObj.getString("office");
