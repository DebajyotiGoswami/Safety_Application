...
<%@page import="org.json.*"%>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			...
			if(!empDtlsJson.has("name") || empDtlsJson.getString("name").equals(""))
				empDtlsJson.put("name","Debajyoti Goswami");
			if(!empDtlsJson.has("erpId") || empDtlsJson.getString("erpId").equals(""))
				empDtlsJson.put("erpId","90012775");
			if(!empDtlsJson.has("designation") || empDtlsJson.getString("designation").equals(""))
				empDtlsJson.put("designation","DE(IT&C)");
			if(!empDtlsJson.has("office") || empDtlsJson.getString("office").equals(""))
				empDtlsJson.put("office","IT&C Cell");
			
            username = empDtlsJson.getString("name"); // Default value if user details are not found
            erpId = empDtlsJson.getString("erpId"); // Default value if ERP ID is not found
            designation=  empDtlsJson.getString("designation");
			office= empDtlsJson.getString("office");
