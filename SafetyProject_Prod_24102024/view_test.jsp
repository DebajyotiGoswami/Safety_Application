...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="details-section">
            ...
            <!-- Second Line -->
            <div class="form-row">
                <!-- <label for="inspectionDate" class="red-text"></label>  -->
            ...
            <!-- Third Line -->
            <div class="form-row">
                <!-- <label for="problemDetails" class="red-text"></label>  -->
            ...
            <!-- Fourth Line -->
            <div class="form-row">
                <!-- <label for="location" class="red-text"></label>  -->
            ...
            <!-- Fifth Line -->
            <div class="form-row">
               <!--  <label for="inspectionBy" class="red-text"></label>  -->
